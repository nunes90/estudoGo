// activity5.02 - calculating the payable amount for employees based on working hours
...
const (
	Sunday Weekday = iota // starting with 0
	Monday
	Tuesday
	Wednesday
	Thursday
...
func main() {
	...
	fmt.Println("Tracking hours worked this far today: ", x(3))
	fmt.Println("Tracking hours worked this far today: ", x(5))
	fmt.Println()
	d.LogHours(Monday, 8)
...
func (d *Developer) PayDetails() {
	...
	fmt.Println("Is this ovetime pay: ", overtime)
	fmt.Println()
